...
import { Text, View, KeyboardAvoidingView, StyleSheet, TouchableWithoutFeedback, Keyboard, Pressable } from "react-native";
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
          <View style={styles.modal}>
            ...
            <View style={styles.buttonSection}>
              ...
              <AddTaskModalButtons style={{ marginRight: 20, backgroundColor: 'transparent', color: 'black' }} onPress={props.onPress} Text={"Cancel"} />
              <AddTaskModalButtons onPress={props.onPress} Text={"Done"} />
